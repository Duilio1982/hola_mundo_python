...
print ('el resultado de sumar 4 y 2 es', suma)

# Resta
resta = numero_1 - numero_2
print ('el resultado de restar 4 y 2 es', resta)

# División
division = numero_1 / numero_2
print('el resultado de dividir 4 y 2 es', division)

# Multiplicación
multiplicacion = numero_1 * numero_2
print('el resultado de multiplicar 4 y 2 es', multiplicacion)